...
const BACKEND_NAME: &str = "gitee-mcp-backend.exe";
const BACKEND_PORT: u16 = 11161;
const BACKEND_TAG: &str = "gitee-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "PORT";
const ENV_HOST: &str = "HOST";
const ENV_TAURI: &str = "GITEE_MCP_TAURI";
...
pub fn spawn_backend(app: AppHandle, state: &BackendProcess) -> Result<String, String> {
    ...
    log_line(
        &app,
        &format!("spawning {} (cwd {}) on port 11161",
